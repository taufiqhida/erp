...
const addPreset = () => {
    addForm.post(route('pengaturan.sumber-lead.store'), {
...
<template>
    <PengaturanLayout title="Sumber Lead">
            <div>
                <h1 class="text-white font-bold text-xl">Sumber Lead</h1>
                <p class="text-slate-400 text-sm mt-0.5">Daftar asal lead konsumen (mis. Instagram, Referral, Pameran) yang bisa dipilih sales saat booking konsumen baru.</p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
                ...
                <div class="px-5 py-4 border-t border-slate-800 bg-slate-800/20">
                    <div class="flex gap-3">
                        <input v-model="addForm.nama" type="text" placeholder="Nama sumber lead (mis. Instagram)"
